 ...
 * @param {string} action — тип действия (Добавление, Редактирование, Осеменение, Отёл, Запуск (сухостой), Протокол, УЗИ, Удаление)
 * @param {string} [details] — описание (опционально)
 */
