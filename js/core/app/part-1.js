...
function saveCurrentEntry() {
  ...
  // register functions
  NS.runApiAppInit = runApiAppInit;
  NS.initApp = initApp;
  NS.addEntry = addEntry;
  NS.cloneEntryForEdit = cloneEntryForEdit;
  NS.entriesEqualForSync = entriesEqualForSync;
  NS.saveCurrentEntry = saveCurrentEntry;
})();
export {};
