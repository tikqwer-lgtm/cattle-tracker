...
const stallLayoutRoutes = require('./routes/stall-layout');
const farmCardRoutes = require('./routes/farm-card');
...
app.use('/api/objects', stallLayoutRoutes);
app.use('/api/objects', farmCardRoutes);
