...
function loadDataContextPrompt(dataContext) {
  ...
  return (
    ...
    'Если в сводке есть блок «Замечания к вопросу» или формулировка неоднозначна — сначала кратко укажи на это, ' +
    'не додумывай за пользователя; дай ответ только по однозначной части или предложи переформулировать. ' +
