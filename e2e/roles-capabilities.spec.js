...
const CASES = [
  {
    role: 'inseminator',
    mainVisible: ['Работа со стадом', 'Карточка хозяйства', 'Настройки', 'Выход'],
    hubVisible: ['Животные и списки', 'Действия'],
    hubHidden: ['Аналитика', 'Администрирование', 'Выход', 'Настройки'],
  ...
  {
    role: 'admin',
    mainVisible: ['Работа со стадом', 'Карточка хозяйства', 'Настройки', 'Администрирование', 'Выход'],
    hubVisible: ['Животные и списки', 'Действия', 'Аналитика'],
    hubHidden: ['Администрирование', 'Выход', 'Настройки'],
    blockedScreens: [],
    allowedScreen: 'sync',
    menuNotificationsVisible: false,
  },
