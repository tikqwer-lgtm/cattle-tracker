...
Данные хранятся в **localStorage** браузера под ключом `cattleEntries`.

localStorage - это встроенное хранилище браузера, которое сохраняет данные даже после закрытия браузера.
